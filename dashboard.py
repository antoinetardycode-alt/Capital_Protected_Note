...
prix_note = pr.run_pricer(S0, r, sigma, T, nominal, P) # prix qu'on doit payer aujourd'hui si on veut detenir ce
S_T = pr.simulate_index(S0, r, sigma, T, n_simulations) # evolution des prix suivant un mouvement brownien geometrique 
payoff = pr.run_payoff(S0, S_T, P, nominal) # profil de rendement de la partie optionel
